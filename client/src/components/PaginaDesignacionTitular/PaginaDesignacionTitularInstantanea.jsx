        ...
        <div className='notranslate border-2 border-zinc-300 p-4'>
            ...
            <div>
                <div className='flex flex-col items-start'>
                    ...
                    <div className='flex flex-row mt-[2px]'>
                        <p>INSTITUCION:</p>
                        <p className='border-b-[1px] border-black w-[420px] text-center'>CENTRO EDUCATIVO DE TERMINALIDAD PRIMARIA</p>
                        <p>REGION:</p>
                        <p className='border-b-[1px] border-black w-[50px] text-center'>{datosVacante.region}</p>
                    </div>
                    <div className='flex flex-row mt-[2px]'>
                        <p>SEDE:</p>
                        {/*<p className='border-b-[1px] border-black w-[340px] text-center'>{datosVacante.nombre_establecimiento}</p>*/}
                        <p className='border-b-[1px] border-black w-[360px] text-center'></p>
                        <p>LOCALIDAD:</p>
                        <p className='border-b-[1px] border-black w-[200px] text-center'>{datosVacante.localidad}</p>
                    </div>
                    <div className='flex flex-row mt-[2px]'>
                        <p>CARGO:</p>
